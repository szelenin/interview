...
public class Task8Test {
    ...
    public void shouldMySolution(){
        ...
        assertTrue(Task8.isSubtree(one, null));
    }
    ...
    public void shouldBookSolution(){
        ...
        assertTrue(Task8.isSubtree2(one, three));
        assertTrue(Task8.isSubtree2(one, new TreeNode(new TreeNode(7), new TreeNode(4), "3")));
        assertFalse(Task8.isSubtree2(one, new TreeNode(new TreeNode(4), new TreeNode(7), "3")));
        assertFalse(Task8.isSubtree2(one, new TreeNode(new TreeNode(3), null, "2")));
        assertTrue(Task8.isSubtree2(one, null));
    }
